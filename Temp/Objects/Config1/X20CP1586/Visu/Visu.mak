...
PANEL_HW_SOURCE_Visu=C:/BRproject/Ag-Rover/Physical/Config1/Hardware.hw 
...
PAGE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Pages/PageEmpty.page 
...
$(PANEL_HW_VCI_Visu): $(PANEL_HW_SOURCE_Visu) $(VC_LIBRARY_LIST_Visu) $(KEYMAP_SOURCES_Visu) $(PALFILE_Visu)
	$(VCHWPP) -f '$<' -o '$@' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'B4.93' -L '' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.72.6/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'Servo' -vcob '$(VCOBJECT_Visu)'
...
$(TEMP_PATH_Visu)/page.PageEmpty.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/PageEmpty.page $(VC_LANGUAGES_Visu)
